...
const programs = [
  {
    ...
    desc: "Safe, loving care all day long with structured play, cozy naps and engaging activities.",
  },
  {
    slug: "play-group",
    name: "Play Group",
    ...
    desc: "First steps into social learning — songs, sensory play and lots of giggles.",
  },
  {
    slug: "nursery",
    name: "Nursery",
    ...
    desc: "Language, motor skills and early concepts through stories and exploration.",
  },
  {
    slug: "junior-kg",
    name: "Junior KG",
    ...
    desc: "Letters, numbers and confidence — the joyful runway to formal school.",
  },
  {
    slug: "senior-kg",
    name: "Senior KG",
    ...
    desc: "Reading, writing and reasoning — ready for big school, the LSIP way.",
  },
];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg text-foreground/75">
            From first words to first friendships — each curriculum is designed around what your
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 auto-rows-fr">
          {programs.map((p, i) => (
            ...
            >
              ...
              <div
                aria-hidden
                className="absolute -top-12 -right-12 h-40 w-40 rounded-full bg-accent/10 blur-2xl transition group-hover:bg-accent/25"
              />
              <div className="relative flex items-start justify-between gap-3">
                ...
                <div
                  className={`grid h-16 w-16 shrink-0 place-items-center rounded-2xl bg-white border border-[#EEF2FF] p-1 shadow-[var(--shadow-soft)] transition-transform duration-300 group-hover:scale-105 overflow-hidden`}
                >
                  <img
                    src={programIcons[i]}
                    alt={p.name}
              ...
              <p className="relative mt-4 text-sm leading-relaxed text-foreground/75">{p.desc}</p>
              <Link
                to="/programs/$slug"
                params={{ slug: p.slug }}
          ...
          >
            <div
              aria-hidden
              className="absolute -bottom-16 -right-16 h-56 w-56 rounded-full bg-accent/30 blur-3xl"
            />
